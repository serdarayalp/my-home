...
public class DepthFirstPaths {
    ...
    public static void main(String[] args) {
        ...
        /*dfp.printVertexAdjList(g.adj(0));
        dfp.printVertexAdjList(g.adj(1));
        dfp.printVertexAdjList(g.adj(2));
        dfp.printVertexAdjList(g.adj(3));
        ...
        if (dfp.postorder.peek() != null) {
            for (Integer integer : dfp.postorder) {
                System.out.print(integer + " ");
            }
        }
        ...
        for (int i = 0; i < dfp.distTo.length; i++) {
            System.out.println("[" + i + "] -> " + dfp.distTo[i] + " ");
        }

        System.out.println();
        System.out.println();

        List<Integer> path = dfp.pathTo(3);
